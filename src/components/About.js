...
const About = () => {
  ...
  return (
    <div style={{ backgroundColor: '#E6EEF8', minHeight: '100vh' }}>
      {/* Hero Section */}
      <div className="hero-section text-white py-5" style={{ backgroundColor: '#1a365d' }}>
        <div className="container py-5">
          <div className="row align-items-center">
            <div className="col-lg-6" data-aos="fade-right">
              <h1 className="display-4 fw-bold mb-4">Welcome to Our Store</h1>
              <p className="lead mb-4">We specialize in providing high-quality clothing with a focus on customer satisfaction and sustainable fashion.</p>
          ...
          <div className="col-md-4" data-aos="fade-up">
            <div className="card h-100 border-0 shadow-sm hover-effect">
              <div className="card-body text-center p-4">
                ...
                <p className="text-muted mb-0">We ensure quick and reliable delivery to all locations with real-time tracking.</p>
              </div>
            </div>
          </div>
          <div className="col-md-4" data-aos="fade-up" data-aos-delay="100">
            <div className="card h-100 border-0 shadow-sm hover-effect">
              <div className="card-body text-center p-4">
                ...
                <p className="text-muted mb-0">Every product undergoes strict quality checks before reaching our customers.</p>
              </div>
            </div>
          </div>
          <div className="col-md-4" data-aos="fade-up" data-aos-delay="200">
            <div className="card h-100 border-0 shadow-sm hover-effect">
              <div className="card-body text-center p-4">
                ...
                <p className="text-muted mb-0">Our customer support team is always ready to assist you with any queries.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="container py-5">
        <div className="row align-items-center">
          ...
          <div className="col-lg-6" data-aos="fade-left">
            ...
            <p className="lead text-muted mb-4">Started in 2020, we've grown from a small local shop to a nationwide brand trusted by thousands of customers.</p>
            <div className="row g-4 mb-4">
              <div className="col-6">
                <div className="d-flex align-items-center">
                  <i className="bi bi-people text-primary me-2" style={{ fontSize: '1.5rem' }}></i>
                  <div>
